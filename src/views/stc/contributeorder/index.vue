  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="infoTable" :data="list" style="width: 100%;" v-loading="listLoading" border>
        ...
        <el-table-column label="捐赠金额" width="160" align="center">
          <template slot-scope="scope">{{ scope.row.donationAmount }}</template>
        </el-table-column>
        <el-table-column label="捐赠次数" width="160" align="center">
          <template slot-scope="scope">{{ scope.row.donationTimes }}</template>
        </el-table-column>
...
<script>
import { listInfo } from '@/api/contributeorder';
