<template>
  <div class="app-container">
      ...
      <div class="search">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="银行名称：">
            <el-input size="mini" v-model="listQuery.bankName" class="input-width" placeholder="请输入" clearable></el-input>
          </el-form-item>
          <el-form-item label="支行名称：">
            <el-input size="mini" v-model="listQuery.branchName" class="input-width" placeholder="请输入" clearable></el-input>
          </el-form-item>
          <el-form-item label="银行卡号：">
            <el-input size="mini" v-model="listQuery.bankCardNumber" class="input-width" placeholder="请输入" clearable></el-input>
          </el-form-item>
          <el-form-item label="持卡人：">
            <el-input size="mini" v-model="listQuery.cardholder" class="input-width" placeholder="请输入" clearable></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    <el-card class="operate-container" shadow="never">
      ...
      <span>批量操作</span>
      <el-button v-if="false" size="mini" class="btn-add" @click="handleAdd()" style="margin-left: 20px">添加</el-button>
    ...
    <div class="table-container">
      <el-table ref="infoTable" :data="list" style="width: 100%;" v-loading="listLoading" border>
        ...
        <el-table-column label="会员用户名" width="160" align="center">
    ...
    <el-dialog title="详细信息" :visible.sync="dialogDetailVisible">
      ...
      <div class="table-layout">
        <el-row>
          ...
          <el-col :span="4" class="table-cell-title">银行名称</el-col>
          <el-col :span="4" class="table-cell-title">支行名称</el-col>
    ...
    <el-dialog :title="isEdit ? '编辑' : '添加'" :visible.sync="dialogVisible">
      <el-form :model="info" ref="infoForm" :rules="infoRules" label-width="120px" size="small">
        <el-form-item prop="username" label="会员用户名：">
          <el-input v-model="info.username" :value="info.username"  :disabled="isEdit"></el-input>
        </el-form-item>
        <el-form-item prop="realName" label="真实姓名：">
          <el-input v-model="info.realName" :value="info.realName"  :disabled="isEdit"></el-input>
        </el-form-item>
        <el-form-item prop="bankName" label="银行名称：">
          <el-input v-model="info.bankName" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item prop="branchName" label="支行名称：">
          <el-input v-model="info.branchName" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item prop="bankCardNumber" label="银行卡号：">
          <el-input v-model="info.bankCardNumber" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item prop="cardholder" label="持卡人：">
          <el-input v-model="info.cardholder" placeholder="请输入"></el-input>
        </el-form-item>
...
<script>
import { listInfo, addInfo, setInfo, exportExcel } from '@/api/bankCard';
  ...
  data() {
    return {
      ...
      infoRules: {
        ...
        cardholder: [
          { required: true, message: "请输入持卡人", trigger: 'change' }
        ],
